...
algorithm.methods = {
  ...
  */
  ...
  runAlgorithm: function(pt){
    var algoResults = {};
    console.log('pt', pt)
    pt.encounter.targetBP = algorithm.methods.generateTarget(pt);
    algoResults.recs = algorithm.methods.generateRecs(pt, pt.encounter.targetBP);
  ...
  generateRecs: function(pt, targetBP){
    ...
    */
    //account for encounter being undefined in 'pt' service; these lines are an extra guard
  ...
  //should only be invoked after pt targetBP is set 
  isAtBPGoal: function(pt) {
    if(pt.encounter.targetBP) {
      if(pt.encounter.bloodPressure.Systolic >= pt.encounter.targetBP.Systolic || pt.encounter.bloodPressure.Diastolic >= pt.encounter.targetBP.Diastolic) {
        return false;
      }
      return true;
    } else {
