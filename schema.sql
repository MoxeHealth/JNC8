...
CREATE TABLE `encounters` (
  ...
  `pt_id` VARCHAR(200) NULL DEFAULT NULL,
  `org_id` VARCHAR(200) NULL DEFAULT NULL,
  `emails` VARCHAR(200) NULL DEFAULT NULL,
  `encounter_date` DATETIME NULL DEFAULT NULL,
  `blood_pressure` VARCHAR(200) NULL DEFAULT NULL,
  `target_bp` VARCHAR(200) NULL DEFAULT NULL,
  `prescribed_meds` VARCHAR(500) NULL DEFAULT NULL,
  `removed_meds` VARCHAR(500) NULL DEFAULT NULL,
  `current_meds` VARCHAR(500) NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
);
